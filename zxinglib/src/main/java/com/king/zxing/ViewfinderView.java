...
//    private final int resultColor;
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        labelTextColor = ContextCompat.getColor(context,R.color.viewfinder_text_color);
//        labelTextColor = array.getColor(R.styleable.ViewfinderView1_textColor, ContextCompat.getColor(context,R.color.viewfinder_text_color));
