...
public class ToggleButton extends View {
    ...
    public void setup(AttributeSet attrs) {
        ...
        paintText.setStrokeCap(Cap.ROUND);
        ...
        defaultAnimate = typedArray.getBoolean(R.styleable.ToggleButton_animates, defaultAnimate);
        onText = typedArray.getString(R.styleable.ToggleButton_textOn);
        offText = typedArray.getString(R.styleable.ToggleButton_textOff);
        typedArray.recycle();
...
//            canvas.drawText(offText, spotX + cy + 9, centerY + 9, paintText);
        }
...
//        canvas.drawText(onText, spotX - spotR - 30, centerY + 9, paintText);
    }
