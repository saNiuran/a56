...
//    }
    ...
    /**
     * 把程序拍摄的照片放到 SD卡的 bszht目录中 imgs 文件夹中
     * 照片的命名规则为：img_20130125_173729.jpg
     */
    public static File createImageFile(Context context) throws IOException {

        SimpleDateFormat format = new SimpleDateFormat("yyyyMMdd_HHmmss");
        String timeStamp = format.format(new Date());
        String imageFileName = "IMG_" + timeStamp + "_" + UUID.randomUUID().toString() + ".jpg";
        File image = new File(getAlbumDir(context), imageFileName);
        HokasUtils.logcat("file : " + image.getAbsolutePath() );
        return image;
    }
