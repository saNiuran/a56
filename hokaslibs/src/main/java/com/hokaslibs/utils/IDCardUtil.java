...
//        Log.d("IDCardUtil", "校验校验码");
    ...
    public static void main(String[] args) {
        boolean mark = isIDCard2("469003199107250013");
        System.out.print("boolean" + mark);
    }
