 ...
 */
public abstract class XRecyclerAdapter<T> extends RecyclerView.Adapter<XRecyclerViewHolder> {
    ...
    public XRecyclerAdapter(Context context, int layoutId, List<T> datas) {
        mContext = context;
