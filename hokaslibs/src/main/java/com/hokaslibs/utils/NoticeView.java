...
/**
 * Created by administor on 2017/8/15.
 */

public class NoticeView extends FrameLayout implements View.OnClickListener {

    private final long DEFAULT_ANIMATION_DURATION = 2000; // 动画时长
...
//                new TranslateAnimation(TranslateAnimation.RELATIVE_TO_PARENT, 1f, TranslateAnimation.RELATIVE_TO_PARENT
//                        , 0, 0, 0, 0, 0);
...
//        TranslateAnimation translateAnimation =
//                new TranslateAnimation(TranslateAnimation.RELATIVE_TO_PARENT, 0, TranslateAnimation.RELATIVE_TO_PARENT
//                        , -1f, 0, 0, 0, 0);
        TranslateAnimation translateAnimation = new TranslateAnimation(
                Animation.RELATIVE_TO_PARENT, 0.0f, Animation.RELATIVE_TO_PARENT, 0.0f,
    ...
    public void setNoticeList(List<String> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            textView.setTextColor(ContextCompat.getColor(getContext(),R.color.color_text_666666));
    ...
    public List<String> getmNoticeList() {
        if (mNoticeList != null && mNoticeList.size() > 0) {
            ...
            for (int i = 0; i < mNoticeList.size(); i++) {
                strings.add(mNoticeList.get(i).getText().toString());
            }
            return strings;
        } else
            return null;
