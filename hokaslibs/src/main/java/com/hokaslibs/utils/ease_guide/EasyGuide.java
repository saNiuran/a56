package com.hokaslibs.utils.ease_guide;
...
import com.hokaslibs.utils.ease_guide.bean.Confirm;
import com.hokaslibs.utils.ease_guide.bean.HighlightArea;
import com.hokaslibs.utils.ease_guide.bean.Message;
import com.hokaslibs.utils.ease_guide.bean.TipsView;
import com.hokaslibs.utils.ease_guide.constant.Constants;
import com.hokaslibs.utils.ease_guide.support.HShape;
import com.hokaslibs.utils.ease_guide.support.OnStateChangedListener;
import com.hokaslibs.utils.ease_guide.view.EasyGuideView;
                            ...
                            if (mAreas.size() > 0) {
                                ...
                                for (HighlightArea area : mAreas) {
                                    ...
                                    if (view != null && inRangeOfView(view, event)) {
                                        ...
                                        if (listener != null) {
                                            listener.onHighlightViewClick(view);
                                        }
