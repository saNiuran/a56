...
public class ProgressActivity extends RelativeLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        emptyStateTitleTextSize =
                typedArray.getDimensionPixelSize(R.styleable.ProgressActivity_emptyTitleTextSize, 14);
    ...
    private void setLoadingView() {
        if (loadingStateRelativeLayout == null) {
            view = inflater.inflate(R.layout.progress_loading, null);
...
//            loadingStateProgressBar.requestLayout();
    ...
    private void setEmptyView() {
        if (emptyStateRelativeLayout == null) {
            view = inflater.inflate(R.layout.progress_empty, null);
...
//            emptyStateContentTextView.setTextColor(emptyStateContentTextColor);
    ...
    public void setEmptyTextPadding(){
        emptyStateTitleTextView.setPadding(0,0,0, 150);
    }


    private void setErrorView() {
        if (errorStateRelativeLayout == null) {
            view = inflater.inflate(R.layout.progress_error, null);
...
//            errorStateButton.setTextColor(errorStateButtonTextColor);
    ...
    public void setErrorTitle(String text) {
        errorStateTitleTextView.setText(text);
    }
    public void setErrorContent(String text) {
        errorStateContentTextView.setText(text);
    }
    public void setTitleVisibilityGone() {
        emptyStateTitleTextView.setVisibility(GONE);
    }

    public void setContentVisibilityGone() {
