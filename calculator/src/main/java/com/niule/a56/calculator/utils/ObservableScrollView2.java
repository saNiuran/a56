...
import com.hokaslibs.utils.NestedParent;
 ...
 */
public class ObservableScrollView2 extends NestedParent {
    ...
    public ObservableScrollView2(Context context, AttributeSet attrs, int defStyleAttr) {
