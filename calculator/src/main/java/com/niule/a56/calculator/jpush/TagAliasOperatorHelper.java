...
public class TagAliasOperatorHelper {
    ...
    private final SparseArray<TagAliasBean> tagAliasActionCache = new SparseArray<TagAliasBean>();
    ...
    private final Handler delaySendHandler = new Handler(Looper.getMainLooper()){
        @Override
