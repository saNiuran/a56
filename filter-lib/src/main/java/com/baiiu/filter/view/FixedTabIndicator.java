...
public class FixedTabIndicator extends LinearLayout {
    ...
    private int mLineSize = 35;  //上线黑线的边距
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //上边黑线
//        canvas.drawRect(mLineSize, 0, measuredWidth - mLineSize, mLineHeight, mLinePaint);

        //下边黑线
        canvas.drawRect(mLineSize, measureHeight - mLineHeight, measuredWidth - mLineSize, measureHeight, mLinePaint);
    }
...
//        addView(generateTextView(list.get(0), 0));
        postInvalidate();
    }
...
//        LinearLayout layout = (LinearLayout) LayoutInflater.from(context).inflate(R.layout.layout_shaixuan, null);
//        ViewGroup.LayoutParams params = new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,ViewGroup.LayoutParams.WRAP_CONTENT);
//        layout.setLayoutParams(params);
//        layout.findViewById(R.id.flOne).setOnClickListener(new OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                switchTab(v.getId());
//            }
//        });
//        layout.findViewById(R.id.flTwo).setOnClickListener(new OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                switchTab(v.getId());
//            }
